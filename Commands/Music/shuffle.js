...
module.exports = class ShuffleCommand extends Command {
  constructor(client) {
    super(client, {
      commandName: 'shuffle',
      commandAliases: [],
      commandDescription: 'Revuelve la lista de reproducción.',
      commandUsage: 'shuffle',
      commandUsageExample: 'shuffle',
  ...
  async run(message, args) {
    ...
    try {
      ...
      const embed_success = new MessageEmbed()
        ...
        .setDescription(
          'La lista de reproducción ha sido revuelta de forma exitosa.'
        );
      message.channel.send({ embeds: [embed_success] });
    } catch (error) {
      console.error(
