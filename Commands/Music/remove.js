...
module.exports = class RemoveCommand extends Command {
  constructor(client) {
    super(client, {
      commandName: 'remove',
      commandAliases: ['rm', 'quit'],
      commandDescription:
        'Quita una canción en especifico de la lista de reproducción.',
      commandUsage: 'remove',
      commandUsageExample: 'remove [número de la canción]',
    ...
    try {
      ...
      if (!args[0]) {
        return _errorEmbed(
          ...
          client._colors.red,
          `> Comando __${client._capitalize(this._information.commandName)}__`,
          `${client._emojis.no_entry_sign} Usted debe ingresar la canción a la cual desee remover.`,
          true,
          'Uso correcto:',
      ...
      if (isNaN(Number(args[0]))) {
        return _errorEmbed(
          ...
          client._colors.red,
          `> Comando __${client._capitalize(this._information.commandName)}__`,
          `${client._emojis.no_entry_sign} Usted debe ingresar únicamente números.`,
          false
        );
      }
      ...
      if (Number(args[0]) > player.queue.size) {
        return _errorEmbed(
          ...
          client._colors.red,
          `> Comando __${client._capitalize(this._information.commandName)}__`,
          `${client._emojis.no_entry_sign} El número de canción no coincide con el tamaño de la lista de reproducción.`,
          false
        );
      }
      ...
      const embed_success = new MessageEmbed()
        ...
        .setDescription(
          `La canción número **${Number(args[0])}** ha sido removida.`
        );
